...
//função para obter as tarefas por ID por meio do método GET
...
//função para atualizar as tarefas por meio do método PUT
...
//função para deletar as tarefas por meio do método DELETE
const deleteTask = (id) => {
    const tasks = lerTarefasDoArquivo();
